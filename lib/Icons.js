// Καθαρά εικονίδια γραμμής — αντικαθιστούν τα emoji στα κουμπιά.
const base = {
  width: 16,
  height: 16,
  viewBox: "0 0 24 24",
...
export const IconEmpty = (p) => (
  <svg {...base} {...p} width={p?.width || 40} height={p?.height || 40} strokeWidth={1.4}>
    <path d="M3 7v10a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2h-7L10 5H5a2 2 0 0 0-2 2z" />
